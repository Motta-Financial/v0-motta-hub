...
/**
 * /meetings/calendly — Calendly bookings + master calendar.
 *
 ...
 * because the component itself adapts to the user's connection state —
 * kept this way to avoid duplicating the OAuth-state UI.
 */
export default function MeetingsCalendlyPage() {
