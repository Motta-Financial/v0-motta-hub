...
/**
 * /clients/meetings — Overview hub for the three client-meeting
 * surfaces. Each tile deep-links into its child route. We deliberately
 * keep this static (no live counts) so the page is fast and the data
 * stays canonical to the child dashboards — Calendly counts live in
 * the Calendly dashboard, Zoom counts live in the Zoom dashboard, etc.
 *
 * The DashboardLayout chrome + sticky sub-nav are owned by the parent
 * `app/clients/meetings/layout.tsx`, so this page only renders the
 * page body.
 */
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-stone-600 mt-1">
          Calendly bookings, Zoom recordings, and post-meeting debriefs in one place. Auto-linking from each surface flows
          into the master client mapping.
        </p>
      </div>
