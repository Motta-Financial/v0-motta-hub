...
function mapKarbonToSupabase(org: KarbonOrganization): Record<string, any> {
  ...
  return {
    ...
    full_name: (org as any).FullName || org.OrganizationName || org.LegalName || null,
    legal_name: org.LegalName || null,
    trading_name: org.TradingName || null,
    description: org.Description || null,
    entity_type: entityType,
    contact_type: org.ContactType || null,
    restriction_level: (org as any).RestrictionLevel || null,
    user_defined_identifier: (org as any).UserDefinedIdentifier || null,
    ...
    client_owner_key: (org as any).ClientOwnerKey || null,
    ...
    karbon_url: `https://app2.karbonhq.com/4mTyp9lLRWTC#/organizations/${orgKey}`,
