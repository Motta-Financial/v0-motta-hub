    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#6B745D] mx-auto mb-4" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-6">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-[#6B745D]/10 rounded-lg">
              <Calendar className="h-6 w-6 text-[#6B745D]" />
            </div>
            <div>
