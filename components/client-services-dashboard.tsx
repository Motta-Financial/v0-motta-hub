...
import { CalendarClock, Video, Headphones } from "lucide-react"
...
export function ClientServicesDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs — Meeting Notes removed; debrief notes now live on the Debriefs page. */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid w-full grid-cols-2 lg:w-auto lg:inline-grid h-auto p-1 bg-white border">
          <TabsTrigger
            value="calendly"
